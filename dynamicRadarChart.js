...
function DynamicRadarChart(id, data, options) {
	var cfg = {
	 ...
	 margin: {top: 30, right: 30, bottom: 30, left: 30}, //The margins around the circle
	 legendPosition: {x: 5, y: 5}, // the position of the legend, from the top-left corner of the svg
	 //legendPosition_other: {x: 500, y: 5}, // the position of the legend, from the top-left corner of the svg
	...
	var g = svg.append("g")
			...
			// first:  + (cfg.w/2 + cfg.margin.left) +
			// second: + (cfg.h/2 + cfg.margin.top) +
	//var g = svg2.append("g")
			//.attr("transform", "translate("  + (cfg.w/2 + cfg.margin.left) + "," + (cfg.h/2 + cfg.margin.top) + ")");
	/////////////////////////////////////////////////////////
...
svg.select(".legendOrdinal")
  .call(legendOrdinal);
	...
	//	svg.append("g")
  //	.attr("class", "legendOrdinal_other")
  //	.attr("transform", "translate(" + cfg["legendPosition_other"]["x"] + "," + cfg["legendPosition_other"]["y"] + ")");

//	var legendOrdinal_other = d3.legend.color()
  //d3 symbol creates a path-string, for example
  //"M0,-8.059274488676564L9.306048591020996,
  //8.059274488676564 -9.306048591020996,8.059274488676564Z"
  //	.shape("path", d3.svg.symbol().type("triangle-up").size(150)())
...
//svg.select(".legendOrdinal_other")
  //.call(legendOrdinal_other);
